    ...
    <div className="relative inline-block text-right" ref={ref}>
      <div>
        <button
          ...
          type="button"
          className={`inline-flex w-full justify-center gap-x-1.5 whitespace-nowrap rounded-lg bg-gray-200 px-3 py-2 text-sm shadow-sm ${className}`}
        >
        ...
        <div className="py-1">
          {options.map((options, i) => (
            <div
              ...
              className="block cursor-pointer px-4 py-2 text-sm hover:bg-primary hover:text-white"
            >
              {options.label}
            </div>
          ))}
