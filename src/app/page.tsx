...
import SceneModelHomepage from "@/components/3D";
  ...
  return (
    <OnboardProvider>
      ...
      <div
        ...
        className=" absolute z-[9998] items-center gap-2 rounded-[26px] bg-[#ffffff4d] p-[10px] text-[12px] "
        ref={boxRef}
        id="mouse-box"
      >
        {" "}
        <SpeakerIcon /> <span id="text-click">{t("3dPage.clickAnywhereToEnableSound")}</span>
      </div>
      ...
      <div className="pointer-events-none fixed bottom-0 z-[100]  w-full xs:px-5 xs:py-4 lg:px-14 lg:py-8">
        <div className="flex justify-between">
          ...
          <div className="flex-1 items-center justify-between xs:hidden lg:flex ">
            ...
            <div
              className="soundbar group pointer-events-auto "
              onClick={() => {
                if (!isPlaying) {
